...
void afc::CrcTest::testCrc64Reversed()
{
	...
	{
		// Non-aligned by 8 data is used.
		alignas(8)
		unsigned char data[] =
				{0x44, 0x99, 0xeb, 0x96, 0xdd, 0x94, 0xc8, 0x8e, 0x97, 0x5b, 0x58, 0x5d, 0x2f, 0x28, 0x78, 0x5e, 0x36};
		CPPUNIT_ASSERT_EQUAL(0xdb7ac38f63413c4eu, afc::crc64Reversed(data + 1, sizeof(data) - 1));
	}
}
